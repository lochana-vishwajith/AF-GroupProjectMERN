                    ...
                    <div className="reg-outer-box">
                        <div className="reg-inner-box">
                            ...
                            <div className="card-body">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus aliquam atque consequuntur cum cumque eveniet fugiat ipsam magnam neque, nihil nobis non quas quia repellendus saepe sit, temporibus voluptas. Repellendus.</p>
                                <Button
                                    type ={"submit"}
                        ...
                        <div className="reg-inner-box">
                            ...
                            <div className="card-body">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet aspernatur culpa cum debitis earum eligendi et, facere hic in maiores molestiae numquam officia provident rerum sapiente soluta velit vitae voluptate.</p>
                                <Button
                                    type ={"submit"}
                                    classname={"btn btn-secondary btn-lg btn-block"}
